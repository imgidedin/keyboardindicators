...
internal static class AppLocalization
{
    ...
    private static readonly AppStrings PortugueseBrazil = new()
    {
        ...
        EnglishLabel = "English",
        PortugueseBrazilLabel = "Portugues (Brasil)",
        ...
        SettingsDescription = "Esses atalhos servem apenas como lembrete. Clique em um campo, pressione a sequencia na ordem desejada e salve. Se deixar vazio, o popup mostra apenas a propria tecla.",
        Save = "Salvar",
        Cancel = "Cancelar",
        Clear = "Limpar",
